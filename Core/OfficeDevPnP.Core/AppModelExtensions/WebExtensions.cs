...
namespace Microsoft.SharePoint.Client
{
	...
	public static partial class WebExtensions
	{
		...
		#region ITaCS Extensions
		/// <summary>
		/// Returns the ListItem of the WelcomePage 
		/// </summary>
		/// <param name="web"></param>
		/// <returns></returns>
		public static ListItem GetWelcomePageItem(this Web web)
		{
			var rootFolder = web.EnsureProperty(w => w.RootFolder);
			var welcomePage = web.GetFileByServerRelativeUrl(rootFolder.ServerRelativeUrl + rootFolder.WelcomePage);
			web.Context.Load(welcomePage);
			web.Context.ExecuteQueryRetry();

			var welcomeItem = welcomePage.EnsureProperty(f => f.ListItemAllFields);
			return welcomeItem;
		}
		#endregion
	}
